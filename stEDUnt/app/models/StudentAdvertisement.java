...
public class StudentAdvertisement extends Advertisement {
	...
	public static StudentAdvertisement create(Student student, String studies, String description, Long id, boolean testAd) {
		StudentAdvertisement ad = StudentAdvertisement.find.byId(id);

		if(ad == null){
			ad = new StudentAdvertisement(student, studies, description, testAd);
		}else{
